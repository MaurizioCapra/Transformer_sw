...
train_stream = trax.data.tf_inputs.TFDS('wmt14_translate', keys=('de', 'en'), train=True)()
eval_stream = trax.data.tf_inputs.TFDS('wmt14_translate', keys=('de', 'en'), train=False)()
