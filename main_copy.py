...
train_stream = trax.data.tf_inputs.TFDS('wmt14_translate', keys=('en', 'fr'), train=True)()
eval_stream = trax.data.tf_inputs.TFDS('wmt14_translate', keys=('en', 'fr'), train=False)()
